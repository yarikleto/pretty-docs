...
- [Visual Studio](https://visualstudio.microsoft.com/) (includes MSVC) — full IDE
- [MSYS2](https://www.msys2.org/) (includes GCC/MinGW) — Unix-like terminal
- [WSL](https://learn.microsoft.com/en-us/windows/wsl/) — run Ubuntu inside Windows, then `apt install g++`
...
<SourceRef section="Getting Started" quote="cppreference.com" />
